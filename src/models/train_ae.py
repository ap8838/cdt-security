...
def train_autoencoder(dataset: str, features_file=None, epochs=20, lr=1e-3):
    ...
    # Keep only numeric data, coerce non-numerics to NaN then fill with 0
    x = (
        df[cols]
...
if __name__ == "__main__":
    ...
    train_autoencoder(
        args.dataset, features_file=args.features_file, epochs=args.epochs, lr=args.lr
    )
